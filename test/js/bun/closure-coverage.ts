...
export const CATEGORIES: CoverageCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      // Roadmap — untested / unhandled value types:
      T("val.boxed-primitive", "boxed primitives (new Number/String/Boolean)"),
      T("val.frozen", "Object.freeze / seal / preventExtensions preserved"),
      T("val.other-typedarrays", "Float64Array / BigInt64Array / DataView / ArrayBuffer"),
      T("val.shared-arraybuffer", "SharedArrayBuffer"),
      T("val.error-cause", "Error { cause } and AggregateError"),
      T("val.error-subclass", "user Error subclass"),
      T("val.weakref", "WeakRef / FinalizationRegistry (should be clear error)"),
      T("val.to-primitive", "object with custom Symbol.toPrimitive / valueOf"),
      T("val.own-accessor-instance", "instance own (not prototype) accessor"),
      T("val.map-fn-keys", "Map/Set with function or object keys identity-preserved"),
    ],
  },
  {
